...
export interface ApiDirectorySubCategoryDirectorySubCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'directory_sub_categories';
  info: {
    displayName: 'Directory Sub Category';
    pluralName: 'directory-sub-categories';
    singularName: 'directory-sub-category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDirectoryDirectory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    other_phone_number: Schema.Attribute.String;
...
export interface ApiVoucherVoucher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    vouchers_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::vouchers-category.vouchers-category'
    >;
  };
}

export interface ApiVouchersCategoryVouchersCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'vouchers_categories';
  info: {
    displayName: 'Vouchers  Category';
    pluralName: 'vouchers-categories';
    singularName: 'vouchers-category';
  };
  options: {
    draftAndPublish: true;
  };
